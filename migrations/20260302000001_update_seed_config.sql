-- differentiate 1-min indicator params from 5-min (items 4.1, 4.2)
-- add ADX to hourly timescale, rebalance hourly weights
...
-- insert new differentiated config
INSERT INTO config_versions (
    ...
    now(),
    'orchestrator',
    'v2 config — differentiate 1-min params (RSI 7, MACD fast 6/13/5), add ADX to hourly, rebalance hourly weights',
    '{
        "schema_version": "0.2",
        "config_id": 2,
