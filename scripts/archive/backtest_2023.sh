#!/usr/bin/env bash
# run backtest on every trading day in 2023 (recovery/bull market after 2022 bear)
# generates ~250 trading dates dynamically, skipping weekends and NYSE holidays
# logs all verbose output to logs/backtest_2023_full.log for post-analysis
#
# market context: tech recovery, AI hype begins (NVDA +239%), VIX mostly 12-20,
# strong trending days. tests whether morning-only edge holds in a rally.
#
# usage: ./scripts/backtest_2023.sh [--compound] [extra backtest args...]
# examples:
#   ./scripts/backtest_2023.sh
#   ./scripts/backtest_2023.sh --compound
#   ./scripts/backtest_2023.sh --ticker-override "AAPL:entry_threshold=0.35"
