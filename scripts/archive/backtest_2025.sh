#!/usr/bin/env bash
# run backtest on every trading day in 2025 (most recent full year)
# generates ~250 trading dates dynamically, skipping weekends and NYSE holidays
# logs all verbose output to logs/backtest_2025_full.log for post-analysis
#
# market context: continuation of AI bull, post-election policy shifts,
# rate environment evolving. most recent out-of-sample data.
#
# usage: ./scripts/backtest_2025.sh [--compound] [extra backtest args...]
